...
AUTO_LOAD = ["parrot_flower"]

parrot_power_ns = cg.esphome_ns.namespace("parrot_power")
ParrotPower = parrot_power_ns.class_(
    "ParrotPower", esp32_ble_tracker.ESPBTDeviceListener, cg.Component
)

CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(ParrotPower),
