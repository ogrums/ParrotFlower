...
parrot_pot_ns = cg.esphome_ns.namespace("parrot_pot")
ParrotPot = parrot_pot_ns.class_(
    "ParrotPot", esp32_ble_tracker.ESPBTDeviceListener, cg.Component
)

CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(ParrotPot),
