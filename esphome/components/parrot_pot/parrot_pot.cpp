#include "parrot_pot.h"
#include "esphome/core/log.h"

#ifdef USE_ESP32

namespace esphome {
namespace parrot_pot {

static const char *const TAG = "parrot_pot";

void ParrotPot::dump_config() {
  ESP_LOGCONFIG(TAG, "Parrot Pot");
...
bool ParrotPot::parse_device(const esp32_ble_tracker::ESPBTDevice &device) {
